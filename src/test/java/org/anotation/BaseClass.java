...
public class BaseClass {
	...
	public void getDriver(String browserType) {
		...
		case "Chrome":
			...
			System.setProperty("webdriver.chrome.driver",
					"C:\\Eclipse Tools\\BrowserLaunch\\RestAssured\\Driver\\chromedriver.exe");
		...
		case "Edge":
			...
			System.setProperty("webdriver.edge.driver",
					"C:\\Eclipse Tools\\BrowserLaunch\\RestAssured\\Driver\\msedgedriver.exe");
		...
		case "FireFox":
			...
			System.setProperty("webdriver.fireFox.driver",
					"C:\\Eclipse Tools\\BrowserLaunch\\Anotation\\Driver\\selenium-firefox-driver-3.4.0.jar");
	...
	public static void screenCapture(String name) throws IOException {
		...
		File Destin = new File(
				"C:\\Eclipse Tools\\BrowserLaunch\\Anotation\\target\\Screenshot\\" + name+ ".png");
